...
const Skills = () => {
  return (
    <section
      id="skills"
      className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-16 bg-gradient-to-r from-blue-200 via-purple-300 to-pink-200"
    >
      <h2 className="text-3xl sm:text-4xl font-bold text-black mb-10 border-b-4 inline-block">
        Skills
      </h2>
