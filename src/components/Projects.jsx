...
const projects = [
  {
    ...
    tech: "React, Tailwind CSS, Axios, Formik, ChartJS, Framer Motion, jsPDF, Node.js, Express.js, JWT Authentication, Multer, Nodemailer, MongoDB Atlas, Gemini AI",
    image: QN1,
  ...
  },
  {
    ...
    tech: "React, Tailwind CSS, Axios, Emoji Picker, Node.js, Express.js, Socket.IO, MongoDB (Mongoose), MongoDB Atlas, Cloudinary, Razorpay Payments, Render (Backend), Netlify (Frontend)",
    image: pesi1,
  ...
  },
  {
    ...
    tech: "React.js, React Router DOM, Tailwind CSS, Axios, Formik, React Player, Node.js, Express.js, MongoDB, JWT Authentication",
    image: yummyHubImage,
...
export default function Projects() {
  return (
    <section
      id="projects"
      className="py-16 bg-gradient-to-r from-gray-200 via-yellow-100 to-emerald-200"
    >
        ...
        <div className="space-y-10">
          {projects.map((p, i) => (
            ...
            >
              {/* IMAGE */}
              <motion.div
                className="md:w-1/2 w-full h-64 sm:h-72 rounded-l-2xl overflow-hidden relative bg-white flex items-center justify-center shadow-lg border border-gray-200"
              ...
              {/* CONTENT */}
              <div className="md:w-1/2 w-full p-5 sm:p-6 flex flex-col justify-between">
                <div>
